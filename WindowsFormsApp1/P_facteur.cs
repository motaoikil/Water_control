...
{
    public partial class P_facteur : Form
    {
        public P_facteur()
        {
            InitializeComponent();
        ...
        private void P_facteur_Load(object sender, EventArgs e)
        {
            try
            {
                DateTime d;
                ...
                dv.RowFilter = "date_facteur >= '" + date1.Value + "' and date_facteur <= '" + date2.Value + "' and paie=true";
                ...
                label3.Text = to + " DH :مجموع الفواتير";
            }
            catch (Exception x)
            {
                cx.Close();
